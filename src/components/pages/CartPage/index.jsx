      ...
      <main>
        ...
        <div className="container_content">
          <div className="breadcrumb_container">
            <a href="#">
              Home <span className="span_breadcrumb">&gt; Your Shopping Cart</span>
            </a>
          </div>
          ...
          <div className="content_cart">
                ...
                <div className="game_card">
                  ...
                  <div className="detail_games">
                    <div className="games_details">
                      <div className="titles">Sleeping Dogs: Definitive Edition</div>
                      {/* Icon windows & mac os */}
                      ...
                      <div className="row_notes layout_dd">
                          ...
                          <div className="dropdown_layout dd_dialog_box dd_dialog_input">
                            <div className="dropdown">
                              <select name="option_gift" id="option_gift">
                                ...
                                <option value="#">For my account: private</option>
                        ...
                        <div className="crud_btn btn_add_rem">
                          <div className="add_btn">Add</div>|<div className="remove_btn">Remove</div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="right_col">
              ...
              <div className="payment_card_container">
                ...
                <div className="row mb-10 notePayment">Sales tax will be calculated during checkout where applicable</div>
