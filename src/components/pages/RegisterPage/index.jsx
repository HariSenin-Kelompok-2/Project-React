...
const RegisterPage = () => {
  ...
  return (
    <>
      <Header />
      <main className="flex flex-col pb-10 min-h-screen bg-[#212429] bg-[url('https://store.akamai.steamstatic.com/public/shared/images/joinsteam/acct_creation_bg.jpg')] bg-cover bg-left bg-no-repeat justify-between smFooter:justify-normal lg:pt-5">
